...
import (
	...
	"github.com/ethsign/fabric-x-network/tools/config-builder/internal/compose"
	...
	"github.com/ethsign/fabric-x-network/tools/config-builder/internal/setup"
...
var rootCmd = &cobra.Command{
	Use:   "fabric-x-network/tools/config-builder",
	Short: "Fabric-X Network Builder",
	Long: `fabric-x-network/tools/config-builder is a CLI tool to build, configure, and manage Fabric-X networks.
...
Example:
  fabric-x-network/tools/config-builder setup -c network.yaml -o ./out
  fabric-x-network/tools/config-builder start
  fabric-x-network/tools/config-builder stop
  fabric-x-network/tools/config-builder teardown`,
	Version: "0.0.4",
}
